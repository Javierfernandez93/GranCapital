...
class StripeInt extends Http{
  constructor() {
    ...
    this.public_key = "pk_live_rw6BKT5rhyvpL2OXsQEBJG8D";
  ...
  checkStripePayment(callback,data){
    return this.call('./../../app/application/check_stripe_payment_premium.php',data,callback,false);
  }
  init(callback,data){
    return this.call('./../../app/application/get_stripe_client_secret_premium.php',data,callback,false);
  }
}