...
class WebFlowServices extends Http {
  ...
  analizeImageColors(callback,data){
    return this.call("../../app/application/analize_image_colors.php",data,callback,false,0,'get');
  }
  getElementList(callback,data){
    return this.call("../../app/application/get_element_list.php",data,callback,false,0,'post');
  }
  getImageSearch(callback,data){
    return this.call("../../app/application/get_image_search.php",data,callback,false,0,'get');
  }
  getElementPixels(callback,data){
    return this.call("../../app/application/get_element_pixels.php",data,callback,false,0,'post');
  }
  setPixel(callback,data){
    return this.call("../../app/application/set_pixel.php",data,callback,false,0,'get');
  }
  saveWebFlow(callback,data){
    return this.call("../../app/application/save_webflow.php",data,callback,false,0,'post');
  }
  saveSheetName(callback,data){
    return this.call("../../app/application/save_sheet_name.php",data,callback,false,0,'post');
  }
  toggleChat(callback,data){
    return this.call("../../app/application/toggle_chat.php",data,callback,false,0,'post');
  }
  getVarsForPixel(callback,data){
    return this.call("../../app/application/get_vars_for_pixel.php",data,callback,false,0,'post');
  }
  getAviablePagesPixel(callback,data){
    return this.call("../../app/application/get_aviable_pages_pixel.php",data,callback,false,0,'post');
  }
}
