$(document).ready(function(){
  ...
  function saveProduct(element,store_per_user_id)
  {
    ...
    },{brand:product.getBrand(),store_per_user_id:store_per_user_id,ammount:product.getAmmount(),promo_price:product.getPromoPrice(),cost:product.getCost(),images:imageList.getList(),title:product.getTitle(),sku:product.getSku(),code:product.getCode(),description:product.getDescription(),catalog_brand_id:$("#catalog_brand_id :selected").val(),catalog_product_id:$("#catalog_product_id :selected").val(),catalog_product_state_id:$("#catalog_product_state_id :selected").val(),visible:visible,catalog_color_ids:catalog_color_ids});
  }
