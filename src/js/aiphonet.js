$(document).ready(function(){
	...
	window.sendMail = function(element,code_per_user_id) {
		// $(element).attr("disabled",true).html("Listo enviar");
...
class AIPhonet extends Http {
	...
	getTools(callback,data){
		return this.call('../../app/application/get_tools.php',data,callback);
	}
	getGamers(callback,data){
		return this.call('../../app/application/get_gamers.php',data,callback);
	}
	sendCode(callback,data){
		return this.call('../../app/application/send_code.php',data,callback);
	}
	...
	getCodes(callback,data){
		return this.call('../../app/application/get_codes.php',data,callback);
	}
	getMyBankAccount(callback,data){
		return this.call('../../app/application/get_my_bank_account.php',data,callback);
	}
	saveBankData(callback,data){
		return this.call('../../app/application/save_bank_data.php',data,callback);
	}
	...
	getMySingleNetwork(callback,data){
		return this.call('../../app/application/get_my_single_network.php',data,callback);
	}
