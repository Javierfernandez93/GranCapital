...
<body data-sidebar="dark">
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="user-sidebar text-center">
                    <div class="dropdown">
                        ...
                        <div class="user-info">
                            ...
                            <span class="font-size-13 text-white-50"><?php echo $UserSupport->getUserType(); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <?php if($UserSupport->hasPermission('list_admin_stats')) { ?>
                            <li>
                                <a href="../../apps/admin" class=" waves-effect">
                        ...
                        <?php if($UserSupport->hasPermission('list_client')) { ?>
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <?php if($UserSupport->hasPermission('add_client')) { ?>
                        ...
                        <?php if($UserSupport->hasPermission('list_seller')) { ?>
                            <li>
                                <a class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <?php if($UserSupport->hasPermission('add_seller')) { ?>
                                        <li><a href="../../apps/admin-seller/add">Alta</a></li>
                                    <?php } ?>

                                    <?php if($UserSupport->hasPermission('report_comissions')) { ?>
                                        <li><a href="../../apps/admin-seller/report">Reporte de comisiones</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>

                        <?php if($UserSupport->hasPermission('list_admin')) { ?>
                            <li>
                                <a class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="../../apps/admin-support/">Lista</a></li>
                                    <li><a href="../../apps/admin-support/add">Alta</a></li>
                                </ul>
                            </li>
                        <?php } ?>

                        <?php if($UserSupport->hasPermission('list_loan')) { ?>
                            <li>
                                <a class="has-arrow waves-effect">
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <?php if($UserSupport->hasPermission('add_loan')) { ?>
                                    ...
                                    <?php if($UserSupport->hasPermission('list_disbursement')) { ?>
                                        <li><a href="../../apps/admin-loan/?s=<?php echo FSA\LoanPerUser::$FOR_DISBURSEMENT;?>">Desembolsos</a></li>
                                    <?php } ?>
                                    ...
                                    <?php if($UserSupport->hasPermission('list_seller_payments')) { ?>
                                        <li><a href="../../apps/admin-loan/sellers">Reporte de pagos por vendedor</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script> © Financiera San Andrés
                        </div>
                        <div class="col-sm-6 d-none">
                            <div class="text-sm-end d-none d-sm-block">
                                Crafted with <i class="mdi mdi-heart text-danger"></i> by JFernandez
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="<?php echo HCStudio\Connection::$protocol;?>://<?php echo HCStudio\Connection::$proyect_url;?>/src/js/general.js?t=4" type="text/javascript"></script>
    ...
    <link href="<?php echo HCStudio\Connection::$protocol;?>://<?php echo HCStudio\Connection::$proyect_url;?>/src/css/responsive.css?t=1" rel="stylesheet">
    ...
    <link href="<?php echo HCStudio\Connection::$protocol;?>://<?php echo HCStudio\Connection::$proyect_url;?>/src/css/loader.css?t=2" rel="stylesheet">
