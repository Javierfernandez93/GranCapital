    ...
    <div class="row mt-4">
            ...
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            <canvas id="chart-bars" class="chart-canvas" height="170" width="520"
                                style="display: block; box-sizing: border-box; height: 170px; width: 520px;"></canvas>
                        </div>
                    </div>
        ...
        <div class="col-lg-7">
            <div class="card z-index-2">
                ...
                <div class="card-body p-3">
                    <div class="chart">
                        <canvas id="chart-line" class="chart-canvas" height="300" width="756"
                            style="display: block; box-sizing: border-box; height: 300px; width: 756px;"></canvas>
                    </div>
                </div>
            </div>
        </div>
